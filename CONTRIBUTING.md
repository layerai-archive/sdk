...
In order to run the  tests, first you need to [create an api key](https://docs.layer.ai/docs/getting-started/log-in#log-in-with-an-api-key) from `https://app.layer.ai`. Then run:
